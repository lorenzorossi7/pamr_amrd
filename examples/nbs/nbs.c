...
void nbs_free_data(void)
{
   ...
   initv_(V_n,&phi_r_amp_1,&phi_i_delta_1,x,y,z,&Nx,&Ny,&Nz);
...
void nbs_fill_ex_mask(real *mask, int dim, int *shape, real *bbox, real excised)
{
}
