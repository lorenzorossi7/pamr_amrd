...
char *AMRD_hyperbolic_vars[AMRD_MAX_VARS];
char *AMRD_elliptic_vars_t0[AMRD_MAX_VARS];
char *AMRD_elliptic_vars[AMRD_MAX_VARS];
char *AMRD_AMRH_work_vars[AMRD_MAX_VARS];
char *AMRD_MGH_work_vars[AMRD_MAX_VARS];
char *AMRD_AMRH_work_in_MGH_vars[AMRD_MAX_VARS];
...
int *AMRD_save_ivec0;
char *AMRD_vt_times;
char *AMRD_save_n_vars[AMRD_MAX_TIMES][AMRD_MAX_VARS];
char *AMRD_save_mg_vars[AMRD_MAX_VARS];
...
char *AMRD_tnp1_diss_vars[AMRD_MAX_VARS];
char *AMRD_tn_diss_vars[AMRD_MAX_VARS];
...
char *AMRD_rg_diss_vars[AMRD_MAX_VARS];
...
char *AMRD_tnp1_liipb_vars[AMRD_MAX_VARS];
char *AMRD_tnp1_liiab_vars[AMRD_MAX_VARS];
char *AMRD_tnp1_liibb_vars[AMRD_MAX_VARS];

int AMRD_num_interp_AMR_bdy_vars;
int AMRD_interp_AMR_bdy_order;
char *AMRD_interp_AMR_bdy_vars[AMRD_MAX_VARS];
...
int AMRD_cmask_gfn,AMRD_cmask_mg_gfn,AMRD_tre_gfn,AMRD_mg_tre_gfn;
real *AMRD_cmask,*AMRD_cmask_mg,*AMRD_tre,*AMRD_mg_tre;
...
real *AMRD_g_x[PAMR_MAX_DIM],AMRD_g_dx[PAMR_MAX_DIM];
int AMRD_g_shape[PAMR_MAX_DIM],AMRD_g_ghost_width[2*PAMR_MAX_DIM],AMRD_g_rank,AMRD_g_dim,AMRD_g_size,AMRD_g_Nx,AMRD_g_Ny,AMRD_g_Nz;
...
char *AMRD_MG_cnst_data_vars[AMRD_MAX_VARS];
...
char *AMRD_ex_repop1_vars[AMRD_MAX_VARS];

int AMRD_num_ex_repop2_vars;
char *AMRD_ex_repop2_vars[AMRD_MAX_VARS];

int AMRD_num_ex_repop3_vars;
char *AMRD_ex_repop3_vars[AMRD_MAX_VARS];

int AMRD_num_ex_repop4_vars;
char *AMRD_ex_repop4_vars[AMRD_MAX_VARS];
