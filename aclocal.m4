...
dnl                 CPPFLAGS="$CPPFLAGS -DLINUX -D__L -DPORT_GROUP -DWant_c_files"
dnl                 CXXFLAGS="$CXXFLAGS -DLINUX -D__L -DPORT_GROUP -DWant_c_files"
                    CPPFLAGS="$CPPFLAGS -DLINUX -DPORT_GROUP -DWant_c_files"
                    CXXFLAGS="$CXXFLAGS -DLINUX -DPORT_GROUP -DWant_c_files"
                    if test "X$CCF77LIBS" = "X"; then case $F77 in
                        gfortran*) CCF77LIBS='-lgfortran -lm';;
                        *) CCF77LIBS='-lg2c -lm';;
                        esac
                    fi
                 ;;
...
dnl              CPPFLAGS="$CPPFLAGS -DDARWIN -D__ -DWant_c_files"
                 CPPFLAGS="$CPPFLAGS -DDARWIN -D__L -DWant_c_files"
dnl              CXXFLAGS="$CXXFLAGS -DDARWIN -D__ -DWant_c_files"
                 CXXFLAGS="$CXXFLAGS -DDARWIN -D__L -DWant_c_files"
                 if test "X$CCF77LIBS" = "X"; then
                     case $F77 in
                     gfortran*) CCF77LIBS='-lgfortran -lm';;
                     *) CCF77LIBS='-lg2c -lm';;
