...
/*============================================================================= */
/* define hooks for flux correction (hydro)                                     */
/*============================================================================= */
extern void (*app_fcs_var_clear)(int, int *);
void amrd_set_app_fcs_var_clear_hook(void (*app_fcs_var_clear)(int, int *));

extern void (*app_flux_correct)();
void amrd_set_app_flux_correct_hook(void (*app_flux_correct)());

extern void (*app_post_flux_correct)();
...
/*============================================================================= */
extern void (*app_evolve)(int iter, int *ifc_mask);
...
/*============================================================================= */
extern void (*app_fill_ex_mask)(real *mask, real *mask_c, int dim, int *shape, int *shape_c, real *bbox, real excised);
...
#define AMRD_CP_VERSION 3
#define AMRD_MAX_IVEC_SIZE 100000
#define AMRD_MAX_VARS 512
...
extern int AMRD_num_fc_vars;
extern int AMRD_num_past_bdy_interp_vars;
extern int AMRD_num_work_repop_vars;
extern int AMRD_num_AMRH_work_inject_vars;

extern char **AMRD_hyperbolic_vars;
extern char **AMRD_elliptic_vars_t0;
extern char **AMRD_elliptic_vars;
extern char **AMRD_AMRH_work_vars;
extern char **AMRD_MGH_work_vars;
extern char **AMRD_AMRH_work_in_MGH_vars;
extern char **AMRD_fc_vars;
extern char **AMRD_past_bdy_interp_vars;
extern char **AMRD_work_repop_vars;
extern char **AMRD_AMRH_work_inject_vars;

//Variables that have weighted average injection
extern int AMRD_num_inject_wavg_vars;
extern char **AMRD_inject_wavg_vars;
extern int AMRD_num_MG_inject_wavg_vars;
...
extern real AMRD_t0;
extern char *AMRD_c_tag;
extern char *AMRD_v_tag;
extern int AMRD_AMR_bdy_width,AMRD_AMR_bdy_width_c;
extern int AMRD_resid_in_evo;
...
/*If set elliptic vars will have values on the AMR bdy for points that don't exist 
on the parent grid interpolated from those that do after CGC in v-cycle*/
extern int AMRD_MG_reinterp_bdy; 
...
extern int AMRD_using_cc_tre;
/* extern int AMRD_num_TRE_max_hydro; */
/* extern real AMRD_TRE_max_hydro[PAMR_MAX_LEVS];      */
extern int AMRD_TRE_norm;
extern int AMRD_TRE_buffer;
extern int AMRD_TRE_ibc_buffer;
extern int AMRD_TRE_ibc_a_buffer;
...
extern int *AMRD_save_ivec0,AMRD_num_save_mg_vars,AMRD_num_save_n_vars[AMRD_MAX_TIMES];
extern char *AMRD_vt_times;
extern char **AMRD_save_n_vars[AMRD_MAX_TIMES];
extern char **AMRD_save_mg_vars;
...
extern char **AMRD_ex_repop1_vars;

extern int AMRD_num_ex_repop2_vars;
extern char **AMRD_ex_repop2_vars;

extern int AMRD_num_ex_repop3_vars;
extern char **AMRD_ex_repop3_vars;

extern int AMRD_num_ex_repop4_vars;
extern char **AMRD_ex_repop4_vars;
...
extern int AMRD_diss_use_6th_order;
extern int AMRD_diss_stride;
extern int AMRD_num_rg_diss_vars;
extern int AMRD_tnum_rg_diss_vars;
extern char **AMRD_rg_diss_vars;
...
extern char **AMRD_tnp1_liipb_vars;
extern char **AMRD_tnp1_liiab_vars;
extern char **AMRD_tnp1_liibb_vars;
...
extern char **AMRD_interp_AMR_bdy_vars;
...
extern int AMRD_cmask_gfn,AMRD_cmask_mg_gfn,AMRD_tre_gfn,AMRD_mg_tre_gfn,AMRD_w1_gfn,AMRD_w1_c_gfn,AMRD_tre_c_gfn;
extern int AMRD_cmask_c_gfn;
extern int AMRD_fc_mask_gfn;

extern real *AMRD_cmask,*AMRD_cmask_mg,*AMRD_tre,*AMRD_mg_tre,*AMRD_w1,*AMRD_w1_c,*AMRD_tre_c;
extern real *AMRD_cmask_c,*AMRD_fc_mask;

extern int AMRD_chr_gfn,AMRD_chr_mg_gfn;
extern real *AMRD_chr,*AMRD_chr_mg;

extern int AMRD_chr_c_gfn,AMRD_chr_mg_c_gfn;
extern real *AMRD_chr_c,*AMRD_chr_mg_c;

extern int AMRD_wavg_c_gfn,AMRD_wavg_mg_c_gfn;
...
extern int AMRD_work_repop_gfn[AMRD_MAX_VARS];
extern real *AMRD_work_repop[AMRD_MAX_VARS];

extern int AMRD_AMRH_work_inject_gfn[AMRD_MAX_VARS];
extern int AMRD_AMRH_work_inject_op[AMRD_MAX_VARS];

extern int AMRD_inject_wavg_gfn[AMRD_MAX_VARS];
extern int AMRD_MG_inject_wavg_gfn[AMRD_MAX_VARS];

extern int AMRD_past_bdy_interp_vars_gfn[AMRD_MAX_TIMES][AMRD_MAX_VARS];
extern int AMRD_past_bdy_interp_op[AMRD_MAX_VARS];
...
extern real *AMRD_g_x[PAMR_MAX_DIM],*AMRD_g_x_c[PAMR_MAX_DIM],AMRD_g_dx[PAMR_MAX_DIM];
extern int AMRD_g_shape[PAMR_MAX_DIM],AMRD_g_shape_c[PAMR_MAX_DIM],AMRD_g_ghost_width[2*PAMR_MAX_DIM],
           AMRD_g_rank,AMRD_g_dim,AMRD_g_size,AMRD_g_size_c,AMRD_g_Nx,AMRD_g_Ny,AMRD_g_Nz;
extern int AMRD_g_Nx_c,AMRD_g_Ny_c,AMRD_g_Nz_c;
...
extern char **AMRD_MG_cnst_data_vars;

extern int AMRD_num_free_data_vars;
extern int AMRD_free_data_gfn[AMRD_MAX_VARS];
extern real *AMRD_free_data[AMRD_MAX_VARS];
extern char **AMRD_free_data_vars;
...
extern real *AMRD_t_interp_substeps;
extern int AMRD_num_t_interp_substeps;

extern int AMRD_re_interp_width;
extern int AMRD_re_interp_width_c;

extern int AMRD_c_to_v_in_tstep;
extern int AMRD_v_to_c_in_tstep;
...
// fc_mask flags
#define AMRD_SIGN_FLAG 1
#define AMRD_PXFLAG    2
#define AMRD_MXFLAG    4
#define AMRD_PYFLAG    8
#define AMRD_MYFLAG    16
#define AMRD_PZFLAG    32
#define AMRD_MZFLAG    64
