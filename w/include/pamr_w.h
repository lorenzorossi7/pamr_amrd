...
/*====================================================================================================== */
int PAMR_init_context(real *q, int q_size, int dim, int *shape, real *bbox, char *cp_file, char *v_tag, char *c_tag);
...
int PAMR_def_var_full(char *name, int in_amrh, int in_mgh, int num_tl, int amr_inject,
    ...
    int mg_sync, int mg_noinj_to_amr, int regrid_transfer, int c_to_v, int v_to_c,
    int *phys_bdy_type);
int PAMR_set_var_attribs(char *name, int in_amrh, int in_mgh, int num_tl, int amr_inject,
    int amr_interp, int amr_bdy_interp, int amr_sync, int mg_inject, int mg_interp, 
    int mg_sync, int mg_noinj_to_amr, int regrid_transfer, int c_to_v, int v_to_c, int *phys_bdy_type);
...
#define PAMR_VERTEX_CENTERED 0
#define PAMR_CELL_CENTERED 1
...
#define PAMR_HW_RESTR_BDY_SI 4
/* CC */
#define PAMR_NN_AVERAGE 4
#define PAMR_NN_ADD 5
...
/* CC */
#define PAMR_SECOND_ORDER_ENO 1
#define PAMR_FOURTH_ORDER_ENO 3
#define PAMR_FIRST_ORDER_CONS 5
#define PAMR_MC 6
#define PAMR_FIRST_ORDER_EXTENSIVE 7
...
/* cell to vertex and vice-versa transfer operations */
#define PAMR_V_TO_C_NO_TRANSFER 0
#define PAMR_V_TO_C_SECOND_ORDER 1
#define PAMR_V_TO_C_FOURTH_ORDER 2

#define PAMR_C_TO_V_NO_TRANSFER 0
#define PAMR_C_TO_V_SECOND_ORDER 1
#define PAMR_C_TO_V_FOURTH_ORDER 2
#define PAMR_C_TO_V_SECOND_ORDER_ENO 3
#define PAMR_C_TO_V_FOURTH_ORDER_ENO 4
