...
{
   int rank,size,cnt=-1,shape[3]={65,33,33},i,j,l,k,h,ind,h1,h3,h4,h5,nn,mn,sz,shape_c[3];
   ...
   int ghost_width[3]={2,1,3},min_width[3]={9,7,13};
   ...
   int periodic[3]={1,1,1},dummy;

   int SYNC_TEST=1,SAVE_SYNC_TEST=1;
   int INTERP_TEST=1,SAVE_INTERP_TEST=1;
   int BDY_INTERP_TEST=1,SAVE_BDY_INTERP_TEST=1;
   int INJECT_TEST=1,SAVE_INJECT_TEST=1;
   int REGRID_TEST=1,SAVE_REGRID_TEST=1;
   int MGH_TEST=1,SAVE_MGH_TEST=1;
   int EXCISE_TEST=1;
   ...
   cnt=PAMR_init_context(0,0,dim,shape,bbox,0,0,0);
   ...
   f1_n=PAMR_def_var_full("f1",1,1,4,PAMR_HW_RESTR,PAMR_FOURTH_ORDER,PAMR_FOURTH_ORDER,PAMR_SYNC,
                         PAMR_HW_RESTR,PAMR_FOURTH_ORDER,PAMR_SYNC,1,PAMR_NO_TRANSFER,0,0,phys_bnd1);
   f2_n=PAMR_def_var_full("f2",1,1,4,PAMR_NO_INJECT,PAMR_FOURTH_ORDER,PAMR_FOURTH_ORDER,PAMR_SYNC,
                         PAMR_HW_RESTR,PAMR_SECOND_ORDER,PAMR_SYNC,1,PAMR_SECOND_ORDER,0,0,phys_bnd1);
   f3_n=PAMR_def_var_full("f3",1,0,2,PAMR_STRAIGHT_INJECT,PAMR_NO_INTERP,PAMR_NO_INTERP,PAMR_NO_SYNC,
                         PAMR_STRAIGHT_INJECT,PAMR_NO_INTERP,PAMR_NO_SYNC,0,PAMR_FOURTH_ORDER,0,0,phys_bnd2);
   f4_n=PAMR_def_var_full("f4",1,0,2,PAMR_FW_RESTR,PAMR_SECOND_ORDER,PAMR_SECOND_ORDER,PAMR_NO_SYNC,
                         PAMR_FW_RESTR,PAMR_SECOND_ORDER,PAMR_NO_SYNC,0,PAMR_NO_TRANSFER,0,0,phys_bnd2);
   f5_n=PAMR_def_var_full("f5",0,1,0,PAMR_NO_INJECT,PAMR_SECOND_ORDER,PAMR_SECOND_ORDER,PAMR_SYNC,
                         PAMR_SECOND_ORDER,PAMR_SECOND_ORDER,PAMR_SYNC,1,PAMR_NO_TRANSFER,0,0,phys_bnd3);
   ...
   chr_n=PAMR_def_var_full("chr",1,1,1,PAMR_NO_INJECT,PAMR_NO_INTERP,PAMR_NO_INTERP,PAMR_NO_SYNC,
                            PAMR_NO_INJECT,PAMR_NO_INTERP,PAMR_NO_SYNC,1,PAMR_NO_TRANSFER,0,0,phys_bnd3);

   if (EXCISE_TEST)
   {
      if (rank==0) printf("testing excision, chr_n=%i\n",chr_n);
      PAMR_excision_on("chr",0,set_ex_mask,EXCISED,1);
   }
   ...
   f2_n=PAMR_get_var_attribs("f2",&in_amrh,&in_mgh,&num_tl,&amr_inject,
                        ...
                        &mg_noinj_to_amr,&regrid_transfer,&dummy,&dummy,phys_bdy_type);
   ...
   if (SYNC_TEST)
   {
      ...
      for (l=1; l<4; l++)
      {
         ...
         while(valid)
         {
            PAMR_get_g_attribs(&rank,&dim,shape,shape_c,bbox_b,ghost_width,&t,&ngfs,x,x_c,gfs);
            sz=1;
