...
extern void primtoU_g( FTYPE prim[], FTYPE gcov[][4], FTYPE gcon[][4], FTYPE gdet,  FTYPE U[], FTYPE GAMMA );
...
extern FTYPE pressure_rho0_u(FTYPE rho0, FTYPE u, FTYPE GAMMA);
extern FTYPE pressure_rho0_w(FTYPE rho0, FTYPE w, FTYPE GAMMA);
